...
submitBtn.addEventListener('click', () => {
    if (emailValid && checkboxEl.checked && passwordValid && sprayRepeatCounter > 1) {
        // Check if entered credentials match
        if (emailEl.value === CREDENTIALS.email && passwordEl.value === CREDENTIALS.password) {
            // Store login state
            ...
            alert(`Invalid email or password! Please use ${CREDENTIALS.email} and ${CREDENTIALS.password}`);
        }
    }
})
...
// Add this JavaScript for click functionality
